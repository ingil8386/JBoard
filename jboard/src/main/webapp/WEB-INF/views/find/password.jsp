...
<head>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            inputUserid.addEventListener("input", resetAuth);
            ...
            btnAuth.addEventListener("click", function () {
                ...
                emailResult.innerText = "회원정보에 등록된 이메일로 인증번호를 발송하고 있습니다.";
                emailResult.style.color = "blue";

                authResult.innerText = "";

                fetch("<%= request.getContextPath() %>/user/find/passwordAuth.do", {
                    method: "post",
                    headers: {
            ...
            btnConfirm.addEventListener("click", function () {
                ...
                fetch("<%= request.getContextPath() %>/user/find/passwordConfirm.do", {
                    method: "post",
                    headers: {
                        "Content-Type": "application/x-www-form-urlencoded"
                    },
            ...
            btnNext.addEventListener("click", function (e) {
                ...
                location.href = "<%= request.getContextPath() %>/user/find/changePassword.do";
            });
        });
    </script>
</head>
        ...
        <main id="find">
            <section class="password">
                ...
                <p>
                    ...
                    회원정보에 등록된 이메일 주소로 인증번호가 발송됩니다.<br>
                    인증번호 확인 후 다음 버튼을 누르면 비밀번호 변경 페이지로 이동합니다.
                </p>
